...
This folder defines all source code for the 'supply_chain' pipeline:
...
* Take a look at the sample under "sample_users_supply_chain.py" to get familiar with the syntax.
